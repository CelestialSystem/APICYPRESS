describe('Free Signup page', () => {
    ...
    it('7. Test to display the subscription options', () => {
        ...
        cy.componentVisiblityCheck(':nth-child(2) > :nth-child(1) > .d-flex', '\n                                                \n                                                Standard\n                                                ');
    ...
    it('11. Test to display the correct subscription details for yearly period', () => {
        ...
        cy.componentVisiblityCheck(':nth-child(2) > :nth-child(3) > .table-plan-text > :nth-child(2)',  '\n                                                    $269.99 / Yearly\n                                                    ');
        cy.componentVisiblityCheck(':nth-child(3) > :nth-child(3) > .table-plan-text > :nth-child(2)', '\n                                                    $1049.99 / Yearly\n                                                    ');
