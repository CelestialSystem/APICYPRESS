...
describe('MediaStack Affiliates page', () => {
    ...
    it('3. Test to Check the title of "Affiliates" page is present', () => {
    ...
    it('5. Test to check "Description" to be present', () => {
        cy.componentVisiblityCheck('.description-label');
    });
  
    it('6. Test to check "Email" input field is present', () => {
    ...
    it('8. Test to check "First Name" input field is present', () => {
    ...
    it('10. Test to check "Password" input field is present', () => {
    ...
    it('13. Test to check "Sign Up" button is present', () => {
        cy.componentVisiblityCheck('.btn', 'Sign Up');
        cy.go('back');
    });
  
    it('14. Test to check title "Why Join the Mediastack Affiliate Program?" is present', () => {
    ...
    it('16. Test to check title "Who Can Become an Mediastack Affiliate?" is present', () => {
    ...
    it('23. Test to Click on collapse button', () => {
        cy.get(':nth-child(2) > .accordion').click({force:true});
