describe('MediaStack Documentation page', () => {
    ...
    it('8. Test to navigate to "Live News" section', () => {
    ...
    it('9. Test to navigate to "Historical News" section', () => {
    ...
    it('10. Test to navigate to "Error Codes" section', () => {
    ...
    it('11.Test to navigate "Specify Sources"', () => {
    ...
    it('12.Test to navigate to "Specify Categories" section', () => {
    ...
    it('13. Test to navigate to "Specify Countries" section', () => {
    ...
    it('14. Test to navigate to "Specify Language" section', () => {
    ...
    it('16. Test to navigate to "PHP" section', () => {
    ...
    it('17. Test to navigate to "Python" section', () => {
    ...
    it('18. Test to navigate to "jQuery" section', () => {
    ...
    it('19. Test to navigate to "GO" section', () => {
    ...
    it('20. Test to navigate to "Ruby" section', () => {
    ...
    it('21. Test to navigate to "Billing Overages" section', () => { 
