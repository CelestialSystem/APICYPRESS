describe('IpApi FAQ Page', () => {
    ...
    it('1. Test to check if FAQ hyperlink is there', () => {
    ...
    it('4. Test to Check the Sub heading general is there', () => {
    ...
    it('6. Test to Check after expand answer is there or not', () => {
    ...
    it('8. Test to Check subheading is "IP Data & API"', () => {
    ...
    it('10. Test to  Check after expand answer is there or not', () => {
      cy.componentVisiblityCheck('.open > .answer');
    });
    ...
    it('12. Test to Check subheading is "Plans, Pricing & Payment"', () => {
    ...
    it('14. Test to  Check after expand answer is there or not', () => {
      cy.componentVisiblityCheck('.open > .answer');
    });
