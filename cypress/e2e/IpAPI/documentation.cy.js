describe('IpApi Documentation Page', () => {
    ...
    it('3. Test to check Get Free Api button', () => {
      cy.componentVisiblityCheck('.sign_up', 'Get Free API Key')
    });
  
    it('4. Test to Click on GET FREE API KEY button', () => {
      cy.get('.sign_up').click();
      cy.assertPathname('/signup/free');
      cy.go('back');
    });
  
    it('5. Test to CODE EXAMPLE button is visible or not', () => {
      cy.componentVisiblityCheck('.go_to_code_examples', 'Code Example');
    });
  
    it('6. Test to click CODE EXAMPLE button ', () => {
    ...
    it('7. Test to check sidebar heading should be "Basic"', () => {
      cy.componentVisiblityCheck(':nth-child(1) > .doc_heading', 'Basics')
    });
  
    it('8. Test to Navigate to API Access Key', () => {
    ...
    it('9. Test to Navigate to API Response', () => {
    ...
    it('10. Test to navigate to "API Endpoints" section', () => {
    ...
    it('11. Test to navigate to "HTTPS Encryption', () => {
    ...
    it('12. Test to navigate to "JSONP Callbacks" section', () => {
    ...
    it('13. Test to navigate to "API Error Codes" section', () => {
    ...
    it('14.Test to check API Features text', () => {
      cy.componentVisiblityCheck(':nth-child(2) > .doc_heading', 'API Features');
    });
  
    it('15.Test to navigate to "Standard Lookup" section', () => {
    ...
    it('16. Test to navigate to "Bulk IP Lookup" section', () => {
    ...
    it('17. Test to navigate to "Origin Ip Lookup" section', () => {
    ...
    it('18. Test to navigate to "Response Objects" section', () => {
    ...
    it('19. Test to navigate to "Specify Response Format" section', () => {
    ...
    it('20. Test to navigate to "Specify Response Field" section', () => {
      cy.get('.menu > :nth-child(3) > :nth-child(3) > a').scrollIntoView();
    ...
    it('21. Test to navigate to "Enable Hostname Lookup" section', () => {
    ...
    it('22. Test to navigate to "Enable Security Data" section', () => {
    ...
    it('23. Test to navigate to Billing text', () => {
    ...
    it('26. Test to check for Upgrade now button', () => {
      cy.get('.platinum-btn').contains('Upgrade now').click();
      cy.go('back');
    });
  
    it('27. Test to check for CONTACT US button is there', () => {
      cy.componentVisiblityCheck('p > .apilayer-support', 'Contact Us');
    });
  
    it('28. Test to check for CONTACT US button is there', () => {
      cy.get('p > .apilayer-support').click();
      cy.assertPathname('/contact');
    });
  
    it('29. Test to check for the footer links documentation', () => {
