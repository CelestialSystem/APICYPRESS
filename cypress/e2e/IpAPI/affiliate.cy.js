describe('IpApi Affiliate Page', () => {
    ...
    it('5. Test to check Title is "iPapi Partner Program"', () => {
    ...
    it('14. Test to check title "Why Join the Ipapi Affiliate Program?"', () => {
    ...
    it('16. Test to check title "Who Can Become an Ipapi Affiliate?"', () => {
