...
describe('Reachability API Pricing page', () => {
    ...
    it('2. Verify the "Reachability API" title is visible', () => {
        cy.get('h1.h2.mb-3.text-primary')
            .should('be.visible') // Ensure the element is visible
            .and('contain.text', 'Reachability API'); // Verify the text content
    });
    ...
    it('5. Test to check "Starter Plan" title and price and other contents are present', () => {
        ...
        cy.get('.plan-price.font-size-4.font-weight-bold.text-primary')
            ...
            .and('contain.text', '$3.99'); // Verify the price text is correct
        ...
        cy.get('.card-body .media-body')
            .contains('15,000 Requests / Monthly')
            .should('exist')
            .and('be.visible');
    ...
    it('7. Test to check "Pro Plan" details are and other contents present', () => {
        ...
        cy.componentVisiblityCheck('.plan-price', '$7.99');
