...
describe('Disposable Email Detection API Pricing page', () => {
    before(() => {
    ...
    it('2. Test to check "Disposable Email Detection API" title and other contents are present', () => {
        cy.componentVisiblityCheck('h1, h2, h3, h4', 'Disposable Email Detection API');
    });
    ...
    it('5. Test to check "Starter Plan" title and price and other contents are present', () => {
        ...
        cy.get('.plan-price.font-size-4.font-weight-bold.text-primary')
            ...
            .and('contain.text', '$1.99'); // Verify the price text is correct
        ...
        cy.get('.card-body .media-body')
            .contains('6,000 Requests / Monthly')
            .should('exist')
            .and('be.visible');
    ...
    it('7. Test to check "Pro Plan" details are and other contents present', () => {
        ...
        cy.componentVisiblityCheck('.plan-price', '$4.99');

        // Check the first feature of "Pro Plan"
        cy.componentVisiblityCheck('.card .media-body', '30,000\nRequests / Monthly');
