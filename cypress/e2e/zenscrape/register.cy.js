describe('Zenscrape register page  ', () => {
    ...
    it('3. Test to Verify subscription text is present or not', () => {
    ...
    it('5. Test to verify subscription for monthly or yearly option availble or not', () => {
    ...
    it('7. Test to check "All subscription plan prices are excluding applicable vat" text is present or not', () => {
    ...
    it('23.Test to verify the profile text is present or not', () => {
    ...
    it('25. Test to check the biling section is present or not for the subscription plans', () => {
