...
describe(' Weatherstack Status Page', () => {
    before(() => {
    ...
    it('2. Test to check "Service status" text is present', () => {
        cy.checkTextVisibility('Service status');
    });

    it('3. Test to check the title "All systems operational" text is present', () => {
        cy.checkTextVisibility('All systems operational');
    });

    it('4. Test to check the subtitle "Uptime Last 90 days"', () => {
        cy.componentVisiblityCheck('.uk-flex-between.uk-flex-middle > .uk-h3', 'Uptime\n                    Last 90 days\n                ');
    });

    it('5. Test to click on the "api.weatherstack.com" link', () => {
    ...
    it('7. Test to check the text "Recent events" is present', () => {
    ...
    it('17. Test to check "Status update history" button is present', () => {
    ...
    it('19. Test to check the title of the history page "Status update history" is present', () => {
