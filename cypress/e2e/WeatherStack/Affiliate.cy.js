describe('Affiliates Page', () => {
    ...
    it('3. Test to Check the title of Earn Passive Income with Weatherstack Affiliate Program ', () => {
    ...
    it('14. Test to check title "Why Join the Weatherstack Affiliate Program?"', () => {
    ...
    it('16. Test to check title "Who Can Become an Weatherstack Affiliate?"', () => {
    ...
    it('25. Test to click on "Sign Up Now and Become an Weatherstack Affiliate!" button', () => {
