...
describe('Pricing Page', () => {
    ...
    it('8. Test to check the "Free" plan details', () => {
    ...
    it('9. Test to check the "Basic" plan details', () => {
    ...
    it('10. Test to check the "Professional" plan details', () => {
    ...
    it('11. Test to check the "Professional Plus" plan details', () => {
    ...
    it('12. Test to check the "Enterprise" plan details', () => {
    ...
    it('16. Test to check the "Features" in the "Professional Plus" plan', () => {
    ...
    it('18. Test to toggle the subscription button to "Monthly"', () => {
        cy.get('.freq_changer').click();
    });

    it('19.Test to chek the "Free" plan for monthly', () => {
    ...
    it('20.Test to chek the "Basic" plan for monthly', () => {
    ...
    it('21.Test to chek the "Professional" plan for monthly' , () => {
    ...
    it('22.Test to chek the "Proffesional Plus" plan for monthly ', () => {
    ...
    it('23.Test to chek the Enterprice plan for monthly', () => {
