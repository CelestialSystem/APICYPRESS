...
describe('Image to text Documentation page', () => {
    before(() => {
    ...
    it('4. Test to check "Image to Text API Reference" title is present', () => {
        cy.checkTextVisibility('Image to Text API Reference');
    });
