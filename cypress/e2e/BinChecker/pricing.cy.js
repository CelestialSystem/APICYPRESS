import { BINCHECKER_BASE_URL, APILAYER_BASE_URL } from '../../resources/data';
...
describe('Bin checker APIs pricing page', ()=> {
    ...
    it('2. Test to check "BIN Checker API" title is present', () => {
    ...
    it('4. Test to check "Starter Plan" features', () => {
        cy.starterPlanCheck('4.99', '15,000');
    });
   
    it('5. Test to check "Pro Plan" features', () => {
        cy.proPlanCheck('9.99', '60,000');
    });
