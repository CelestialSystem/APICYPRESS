...
describe('Image Optimizer API Pricing page', () => {
    before(() => {
    ...
    it('2. Verify the "Image Optimizer API" title is visible', () => {
        cy.get('h1.h2.mb-3.text-primary')
            .should('be.visible') // Ensure the element is visible
            .and('contain.text', 'Image Optimizer API'); // Verify the text content
    });
