describe('MarketStack Documentation Page', () => {
    ...
    it('2. Test to naviagate to the "Documentation" page', () => {
        cy.get('.header > .container > ul > :nth-child(2) > a').click();
        cy.assertPathname('/documentation');
    });

    it('3. Test to check "API Documentation" title in the present', () => {
        cy.componentVisiblityCheck('h1', 'API Documentation');
    });

    it('4. Test to check the text "Getting Started" is present', () => {
        cy.componentVisiblityCheck(':nth-child(1) > .doc_heading', 'Getting Started');
    });

    it('5. Test to navigate to "API Authentication" section', () => {
    ...
    it('7. Test to navigate to "API Error Codes" section', () => {
    ...
    it('8. Test to navigate to "End-of-day Data" section', () => {
    ...
    it('9. Test to navigate to "Intraday Data" section', () => {
    ...
    it('10. Test to navigate to "Splits Data" section', () => {
    ...
    it('11.Test to navigate "Dividends data" section', () => {
    ...
    it('12.Test to navigate to "Tickers" section', () => {
    ...
    it('13. Test to navigate to "Exchanges" section', () => {
    ...
    it('14. Test to navigate to "Currencies" section', () => {
    ...
    it('15. Test to navigate to "Timezones" section', () => {
    ...
    it('16. Test to navigate to "Billing Overages" section', () => { 
    ...
    it('17. Test to click on "Upgrade" button', () => { 
    ...
    it('18. Test to click on "Upgrade" button', () => { 
