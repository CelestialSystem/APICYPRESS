...
describe('Spam Check API Pricing page', () => {
    before(() => {
    ...
    it('7. Test to check price of "Starter plan" is present', () => {
        cy.componentVisiblityCheck('.card > .card-header > .mb-3 > .plan-price', '$1.99');
    });
    ...
    it('11. Test to check features of "Pro plan" is present', () => {
        cy.get('.media-body').contains('3,000,000 Requests / Monthly').should('be.visible');
        cy.get('.media-body').contains(' Standard Support ').should('be.visible');
    });
