...
describe('Scrapper(Lite Edition) Pricing page', () => {
    ...
    it('5. Test to check "Subscribe" button click and "Free Plan" features (1,500 Requests, free for lifetime, no credit card)', () => {
        ...
        cy.get('body').click();
        cy.get('.media-body').contains(' 1,500 Requests / Monthly').should('be.visible');
    ...
    it('7. Test to check "Starter Plan" price is $8.99', () => {
        cy.componentVisiblityCheck('.card > .card-header > .mb-3 > .plan-price', '$8.99');
    });

    it('8. Test to check "Subscribe" button click and  "Starter Plan" features (150,000 Requestsrequests, standard support)', () => {
    ...
    it('12. Test to check "Subscribe" button click and "Pro Plan" features (1,500,000 requests, standard support)', () => {
